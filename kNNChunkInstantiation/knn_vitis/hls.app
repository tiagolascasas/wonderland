<project xmlns="com.autoesl.autopilot.project" name="knn_vitis" top="kNN_PredictAll">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="knn/knn_6.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="knn/knn_6.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
