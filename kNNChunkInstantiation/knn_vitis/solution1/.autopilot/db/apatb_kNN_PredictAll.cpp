...
extern "C" void kNN_PredictAll_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
{
transaction<32> tr(46526);
aesl_fh.read(AUTOTB_TVOUT_PC_testing_X, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<4>((char*)__xlx_apatb_param_testing_X, 46526);
}
#else
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_testing_X);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > testing_X_pc_buffer(46526);
          int i = 0;
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            if (AESL_token != "") {
              testing_X_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "testing_X" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
  
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 46526; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_testing_X)[j*4+0] = testing_X_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_testing_X)[j*4+1] = testing_X_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_testing_X)[j*4+2] = testing_X_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_testing_X)[j*4+3] = testing_X_pc_buffer[i].range(31, 24).to_int64();
}}}
        } // end transaction
      } // end file is good
...
transaction<32> tr(46612);
  __xlx_offset_byte_param_training_X_0 = 0*4;
  if (__xlx_apatb_param_training_X_0) {
tr.import<4>((char*)__xlx_apatb_param_training_X_0, 46612, 0);
  }
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_training_X_0 + i * 4;
...
transaction<32> tr(46612);
  __xlx_offset_byte_param_training_X_1 = 0*4;
  if (__xlx_apatb_param_training_X_1) {
tr.import<4>((char*)__xlx_apatb_param_training_X_1, 46612, 0);
  }
...
if (__xlx_apatb_param_training_X_1) {
for (size_t i = 0; i < 46612; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_training_X_1 + i * 4;
std::string s = formatData(pos, 32);
...
transaction<32> tr(46612);
  __xlx_offset_byte_param_training_X_2 = 0*4;
  if (__xlx_apatb_param_training_X_2) {
tr.import<4>((char*)__xlx_apatb_param_training_X_2, 46612, 0);
  }
...
if (__xlx_apatb_param_training_X_2) {
for (size_t i = 0; i < 46612; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_training_X_2 + i * 4;
std::string s = formatData(pos, 32);
...
transaction<32> tr(46612);
  __xlx_offset_byte_param_training_X_3 = 0*4;
  if (__xlx_apatb_param_training_X_3) {
tr.import<4>((char*)__xlx_apatb_param_training_X_3, 46612, 0);
  }
...
if (__xlx_apatb_param_training_X_3) {
for (size_t i = 0; i < 46612; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_training_X_3 + i * 4;
std::string s = formatData(pos, 32);
...
transaction<32> tr(46526);
  __xlx_offset_byte_param_testing_X = 0*4;
  if (__xlx_apatb_param_testing_X) {
tr.import<4>((char*)__xlx_apatb_param_testing_X, 46526, 0);
  }
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_testing_X + i * 4;
std::string s = formatData(pos, 32);
...
transaction<32> tr(43);
  __xlx_offset_byte_param_min = 0*4;
  if (__xlx_apatb_param_min) {
tr.import<4>((char*)__xlx_apatb_param_min, 43, 0);
  }
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_min + i * 4;
std::string s = formatData(pos, 32);
...
transaction<32> tr(43);
  __xlx_offset_byte_param_max = 0*4;
  if (__xlx_apatb_param_max) {
tr.import<4>((char*)__xlx_apatb_param_max, 43, 0);
  }
...
if (__xlx_apatb_param_max) {
for (size_t i = 0; i < 43; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_max + i * 4;
std::string s = formatData(pos, 32);
...
kNN_PredictAll_hw_stub_wrapper(__xlx_apatb_param_training_X_0, __xlx_apatb_param_training_X_1, __xlx_apatb_param_training_X_2, __xlx_apatb_param_training_X_3, __xlx_apatb_param_training_Y, __xlx_apatb_param_testing_X, __xlx_apatb_param_testing_Y, __xlx_apatb_param_min, __xlx_apatb_param_max);
CodeState = DUMP_OUTPUTS;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVOUT_testing_X, 'b');
transaction<32> tr(46526);
  __xlx_offset_byte_param_testing_X = 0*4;
  if (__xlx_apatb_param_testing_X) {
tr.import<4>((char*)__xlx_apatb_param_testing_X, 46526, 0);
  }
aesl_fh.write(AUTOTB_TVOUT_testing_X, tr.p, tr.tbytes);
}
...
// print testing_X Transactions
{
aesl_fh.write(AUTOTB_TVOUT_testing_X, begin_str(AESL_transaction));
{
  __xlx_offset_byte_param_testing_X = 0*4;
if (__xlx_apatb_param_testing_X) {
for (size_t i = 0; i < 46526; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_testing_X + i * 4;
std::string s = formatData(pos, 32);
aesl_fh.write(AUTOTB_TVOUT_testing_X, s);
}
}
}

  tcl_file.set_num(46526, &tcl_file.testing_X_depth);
aesl_fh.write(AUTOTB_TVOUT_testing_X, end_str());
}
