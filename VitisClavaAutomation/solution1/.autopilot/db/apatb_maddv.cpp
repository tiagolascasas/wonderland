...
// wrapc file define:
#define AUTOTB_TVIN_C "../tv/cdatafile/c.maddv.autotvin_C.dat"
#define AUTOTB_TVOUT_C "../tv/cdatafile/c.maddv.autotvout_C.dat"
#define AUTOTB_TVIN_A "../tv/cdatafile/c.maddv.autotvin_A.dat"
#define AUTOTB_TVOUT_A "../tv/cdatafile/c.maddv.autotvout_A.dat"
#define AUTOTB_TVIN_B "../tv/cdatafile/c.maddv.autotvin_B.dat"
#define AUTOTB_TVOUT_B "../tv/cdatafile/c.maddv.autotvout_B.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_C "../tv/rtldatafile/rtl.maddv.autotvout_C.dat"
#define AUTOTB_TVOUT_PC_A "../tv/rtldatafile/rtl.maddv.autotvout_A.dat"
#define AUTOTB_TVOUT_PC_B "../tv/rtldatafile/rtl.maddv.autotvout_B.dat"
...
extern "C" void maddv_hw_stub_wrapper(volatile void *, volatile void *, volatile void *);

extern "C" void apatb_maddv_hw(volatile void * __xlx_apatb_param_C, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B) {
...
tr.send<4>((char*)__xlx_apatb_param_C, 4096);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > C_pc_buffer(4096);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4096; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_C)[j*4+0] = C_pc_buffer[i].range(7, 0).to_int64();
...
aesl_fh.write(AUTOTB_TVIN_B, tr.p, tr.tbytes);
  ...
  tcl_file.set_num(4096, &tcl_file.B_depth);
#else
...
maddv_hw_stub_wrapper(__xlx_apatb_param_C, __xlx_apatb_param_A, __xlx_apatb_param_B);
