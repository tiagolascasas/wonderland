...
int checksum(int buf[262144]) {
   ...
   log_file_28 << "printf," << clava_timing_duration_28 << "us" << "\n";
...
void output_dsp(int buf[262144], char *name) {
   ...
   log_file_29 << "fopen," << clava_timing_duration_29 << "us" << "\n";
   ...
   log_file_31 << "fprintf," << clava_timing_duration_31 << "us" << "\n";
   ...
   log_file_32 << "fclose," << clava_timing_duration_32 << "us" << "\n";
}

void output_dsp_rgb(int buf[786432], char *name) {
   std::ofstream log_file_36;
   log_file_36.open("results.csv", std::ios_base::app);
   ...
   log_file_33 << "fopen," << clava_timing_duration_33 << "us" << "\n";
   ...
   log_file_35 << "fprintf," << clava_timing_duration_35 << "us" << "\n";
   std::chrono::high_resolution_clock::time_point clava_timing_start_36 = std::chrono::high_resolution_clock::now();
   fclose(file);
   std::chrono::high_resolution_clock::time_point clava_timing_end_36 = std::chrono::high_resolution_clock::now();
   auto clava_timing_duration_36 = std::chrono::duration_cast<std::chrono::microseconds>(clava_timing_end_36 - clava_timing_start_36).count();
   log_file_36 << "fclose," << clava_timing_duration_36 << "us" << "\n";
}
