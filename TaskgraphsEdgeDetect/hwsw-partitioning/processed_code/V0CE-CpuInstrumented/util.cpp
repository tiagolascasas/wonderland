...
int checksum(int buf[262144]) {
   ...
   log_file_24 << "printf," << clava_timing_duration_24 << "us" << "\n";
   ...
   log_file_25 << "printf," << clava_timing_duration_25 << "us" << "\n";
...
void output_dsp(int buf[262144], char *name) {
   ...
   log_file_26 << "fopen," << clava_timing_duration_26 << "us" << "\n";
   for(int i = 0; i < 512 * 512 - 1; i++) {
      ...
      log_file_27 << "fprintf," << clava_timing_duration_27 << "us" << "\n";
   }
   ...
   log_file_28 << "fprintf," << clava_timing_duration_28 << "us" << "\n";
   ...
   log_file_29 << "fclose," << clava_timing_duration_29 << "us" << "\n";
}
...
void output_dsp_rgb(int buf[786432], char *name) {
   ...
   log_file_30 << "fopen," << clava_timing_duration_30 << "us" << "\n";
   ...
   log_file_32 << "fprintf," << clava_timing_duration_32 << "us" << "\n";
   ...
   log_file_33 << "fclose," << clava_timing_duration_33 << "us" << "\n";
}
