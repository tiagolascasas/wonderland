...
void edge_detect(int image_rgb[786432], int output[262144]) {
   ...
   log_file_5 << "convolve2d," << clava_timing_duration_5 << "us" << "\n";
   ...
   log_file_7 << "convolve2d," << clava_timing_duration_7 << "us" << "\n";
   ...
   log_file_8 << "combthreshold," << clava_timing_duration_8 << "us" << "\n";
}
...
#include "img_512_512.dat"
   ...
   log_file_9 << "now," << clava_timing_duration_9 << "us" << "\n";
   ...
   log_file_10 << "edge_detect," << clava_timing_duration_10 << "us" << "\n";
   ...
   log_file_11 << "now," << clava_timing_duration_11 << "us" << "\n";
   ...
   log_file_13 << "operator-," << clava_timing_duration_13 << "us" << "\n";
   ...
   log_file_12 << "duration_cast," << clava_timing_duration_12 << "us" << "\n";
   ...
   log_file_17 << "count," << clava_timing_duration_17 << "us" << "\n";
