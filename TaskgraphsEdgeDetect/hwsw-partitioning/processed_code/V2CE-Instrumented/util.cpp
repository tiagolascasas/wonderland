...
void output_dsp(int buf[262144], char *name) {
   ...
   log_file_27 << "fopen," << clava_timing_duration_27 << "us" << "\n";
   ...
   log_file_30 << "fclose," << clava_timing_duration_30 << "us" << "\n";
}
...
void output_dsp_rgb(int buf[786432], char *name) {
   ...
   log_file_31 << "fopen," << clava_timing_duration_31 << "us" << "\n";
   ...
   log_file_34 << "fclose," << clava_timing_duration_34 << "us" << "\n";
}
