...
set name rgbToGrayscale_fptrunc_64ns_32_1_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fptrunc} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name rgbToGrayscale_fpext_32ns_64_1_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fpext} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name rgbToGrayscale_dadd_64ns_64ns_64_5_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {dadd} IMPL {fabric} LATENCY 4 ALLOW_PRAGMA 1
}


set name rgbToGrayscale_dmul_64ns_64ns_64_4_med_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {dmul} IMPL {meddsp} LATENCY 3 ALLOW_PRAGMA 1
}


set name rgbToGrayscale_sitodp_32ns_64_4_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set ID 11
set hasByteEnable 0
set MemName rgbToGrayscale_rgbToGrayscale_Pipeline_VITIS_LOOP_165_1_VITIS_LOOP_167_2_mask_table_ROM_AUTObkb
...
set InstName rgbToGrayscale_flow_control_loop_pipe_sequential_init_U
set CompName rgbToGrayscale_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix rgbToGrayscale_ \
}"
} else {
