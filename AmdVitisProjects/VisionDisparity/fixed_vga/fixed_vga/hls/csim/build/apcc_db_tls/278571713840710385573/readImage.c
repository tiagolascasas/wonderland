...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = bitcast i32* %%file_size to i8*, !dbg !14 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_54_count);
  llvm_cbe_tmp__4 = ( char *)(( char *)(&llvm_cbe_file_size));
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = call i64 @fread(i8* %%7, i64 4, i64 1, %%struct._IO_FILE* %%1) nounwind, !dbg !14 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_55_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = bitcast i32* %%compression_method to i8*, !dbg !15 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_72_count);
  llvm_cbe_tmp__22 = ( char *)(( char *)(&llvm_cbe_compression_method));
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = call i64 @fread(i8* %%25, i64 4, i64 1, %%struct._IO_FILE* %%1) nounwind, !dbg !15 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_73_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = bitcast i32* %%bytes_of_bitmap to i8*, !dbg !15 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_74_count);
  llvm_cbe_tmp__24 = ( char *)(( char *)(&llvm_cbe_bytes_of_bitmap));
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = call i64 @fread(i8* %%27, i64 4, i64 1, %%struct._IO_FILE* %%1) nounwind, !dbg !15 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_75_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge215.us = add nsw i32 %%storemerge215.us.in, -1, !dbg !19 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_storemerge215_2e_us_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%69, i32* %%76, align 1, !dbg !19 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_174_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge8.us = add nsw i32 %%storemerge8.us.in, -1, !dbg !19 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_storemerge8_2e_us_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%86 = call i64 @fread(i8* %%tempg, i64 1, i64 1, %%struct._IO_FILE* %%1) nounwind, !dbg !17 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_207_count);
  fread(( char *)(&llvm_cbe_tempg), 1ull, 1ull, (l_struct_OC__IO_FILE *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%llX",1ull);
printf("\nArgument  = 0x%llX",1ull);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%87 = call i64 @fread(i8* %%tempr, i64 1, i64 1, %%struct._IO_FILE* %%1) nounwind, !dbg !17 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_208_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%89, i32* %%96, align 1, !dbg !19 for 0x%llxth hint within @readImage  --> \n", ++aesl_llvm_cbe_228_count);
