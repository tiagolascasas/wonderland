...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds %%struct.I2D* %%Ileft, i64 0, i32 1, !dbg !8 for 0x%llxth hint within @outlined_fun_0  --> \n", ++aesl_llvm_cbe_12_count);
  llvm_cbe_tmp__1 = (signed int *)(&llvm_cbe_Ileft->field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = load i32* %%1, align 4, !dbg !8 for 0x%llxth hint within @outlined_fun_0  --> \n", ++aesl_llvm_cbe_13_count);
  llvm_cbe_tmp__2 = (unsigned int )*llvm_cbe_tmp__1;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%2, i32* %%nr, align 4, !dbg !8 for 0x%llxth hint within @outlined_fun_0  --> \n", ++aesl_llvm_cbe_14_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = load i32* %%win_sz, align 4, !dbg !8 for 0x%llxth hint within @outlined_loop_0  --> \n", ++aesl_llvm_cbe_78_count);
  llvm_cbe_tmp__13 = (unsigned int )*llvm_cbe_win_sz;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = load i32* %%k, align 4, !dbg !8 for 0x%llxth hint within @outlined_loop_0  --> \n", ++aesl_llvm_cbe_79_count);
  llvm_cbe_tmp__14 = (unsigned int )*llvm_cbe_k;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @correlateSAD_2D(%%struct.I2D* %%IleftPadded, %%struct.I2D* %%IrightPadded, %%struct.I2D* %%Iright_moved, i32 %%1, i32 %%2, %%struct.F2D* %%SAD, %%struct.F2D* %%integralImg, %%struct.F2D* %%retSAD) nounwind, !dbg !8 for 0x%llxth hint within @outlined_loop_0  --> \n", ++aesl_llvm_cbe_80_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = load i32* %%k, align 4, !dbg !9 for 0x%llxth hint within @outlined_loop_0  --> \n", ++aesl_llvm_cbe_81_count);
  llvm_cbe_tmp__15 = (unsigned int )*llvm_cbe_k;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i32* %%nr, align 4, !dbg !9 for 0x%llxth hint within @outlined_loop_0  --> \n", ++aesl_llvm_cbe_82_count);
  llvm_cbe_tmp__16 = (unsigned int )*llvm_cbe_nr;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = load i32* %%nc, align 4, !dbg !9 for 0x%llxth hint within @outlined_loop_0  --> \n", ++aesl_llvm_cbe_83_count);
  llvm_cbe_tmp__17 = (unsigned int )*llvm_cbe_nc;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @findDisparity(%%struct.F2D* %%retSAD, %%struct.F2D* %%minSAD, %%struct.I2D* %%retDisp, i32 %%3, i32 %%4, i32 %%5) nounwind, !dbg !9 for 0x%llxth hint within @outlined_loop_0  --> \n", ++aesl_llvm_cbe_84_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load i32* %%half_win_sz, align 4, !dbg !13 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_163_count);
  llvm_cbe_tmp__23 = (unsigned int )*(&llvm_cbe_half_win_sz);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  call void @iSetArray_rep1(i32 1, i32 2, i32 %%6, %%struct.I2D** %%halfWin) nounwind, !dbg !13 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_164_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = load %%struct.I2D** %%halfWin, align 8, !dbg !9 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_190_count);
  llvm_cbe_tmp__26 = (l_struct_OC_I2D *)*(&llvm_cbe_halfWin);
if (AESL_DEBUG_TRACE)
printf("\n  call void @padarray2_rep1(%%struct.I2D* %%Iright, %%struct.I2D* %%11, %%struct.I2D** %%IrightPadded) nounwind, !dbg !9 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_191_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = load i32* %%cols, align 4, !dbg !14 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_257_count);
  llvm_cbe_tmp__35 = (unsigned int )*(&llvm_cbe_cols);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__35);
if (AESL_DEBUG_TRACE)
printf("\n  call void @iSetArray_rep2(i32 %%14, i32 %%21, i32 0, %%struct.I2D** %%Iright_moved) nounwind, !dbg !14 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_258_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* %%k, align 4, !dbg !14 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_265_count);
  *(&llvm_cbe_k) = 0u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 0u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = load i32* %%k, align 4, !dbg !14 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_331_count);
  llvm_cbe_tmp__44 = (unsigned int )*(&llvm_cbe_k);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__44);
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = add nsw i32 %%31, 1, !dbg !14 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_332_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%32, i32* %%k, align 4, !dbg !14 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_339_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = load %%struct.I2D** %%IleftPadded, align 8, !dbg !15 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_397_count);
  llvm_cbe_tmp__52 = (l_struct_OC_I2D *)*(&llvm_cbe_IleftPadded);
if (AESL_DEBUG_TRACE)
printf("\n  call void @iFreeHandle_rep2(%%struct.I2D* %%40) nounwind, !dbg !15 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_398_count);
  iFreeHandle_rep2((l_struct_OC_I2D *)llvm_cbe_tmp__52);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = load %%struct.I2D** %%Iright_moved, align 8, !dbg !15 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_405_count);
  llvm_cbe_tmp__53 = (l_struct_OC_I2D *)*(&llvm_cbe_Iright_moved);
if (AESL_DEBUG_TRACE)
printf("\n  call void @iFreeHandle_rep3(%%struct.I2D* %%41) nounwind, !dbg !15 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_406_count);
  iFreeHandle_rep3((l_struct_OC_I2D *)llvm_cbe_tmp__53);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = load %%struct.I2D** %%retDisp, align 8, !dbg !10 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_413_count);
  llvm_cbe_tmp__54 = (l_struct_OC_I2D *)*(&llvm_cbe_retDisp);
if (AESL_DEBUG_TRACE)
printf("\n  store %%struct.I2D* %%42, %%struct.I2D** %%rtr_val, align 8, !dbg !10 for 0x%llxth hint within @getDisparity  --> \n", ++aesl_llvm_cbe_414_count);
