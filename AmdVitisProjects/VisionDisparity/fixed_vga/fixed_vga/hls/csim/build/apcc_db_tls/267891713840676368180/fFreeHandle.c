...
if (AESL_DEBUG_TRACE)
printf("\n  call void @outlined_fun_24(i32* %%decomp_0, %%struct.F2D* %%out), !dbg !5 for 0x%llxth hint within @fFreeHandle_rep3  --> \n", ++aesl_llvm_cbe_23_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @outlined_fun_23(i32* %%decomp_0, %%struct.F2D* %%out), !dbg !5 for 0x%llxth hint within @fFreeHandle_rep2  --> \n", ++aesl_llvm_cbe_49_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @outlined_fun_22(i32* %%decomp_0, %%struct.F2D* %%out), !dbg !5 for 0x%llxth hint within @fFreeHandle_rep1  --> \n", ++aesl_llvm_cbe_75_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @outlined_fun_21(i32* %%decomp_0, %%struct.F2D* %%out), !dbg !5 for 0x%llxth hint within @fFreeHandle_rep0  --> \n", ++aesl_llvm_cbe_101_count);
