...
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load i32* %%3, align 4, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__6 = (unsigned int )*llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = mul nsw i32 %%10, %%storemerge3.us, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_35_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = add nsw i32 %%11, %%storemerge12.us, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_36_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = sext i32 %%12 to i64, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_37_count);
  llvm_cbe_tmp__9 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds %%struct.F2D* %%in, i64 0, i32 2, i64 %%13, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__10 = (float *)(&llvm_cbe_in->field2[(((signed long long )llvm_cbe_tmp__9))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%llX",((signed long long )llvm_cbe_tmp__9));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = load float* %%14, align 4, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_39_count);
  llvm_cbe_tmp__11 = (float )*llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__11, *(int*)(&llvm_cbe_tmp__11));
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = load %%struct.F2D** %%out, align 8, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__12 = (l_struct_OC_F2D *)*(&llvm_cbe_out);
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = getelementptr inbounds %%struct.F2D* %%16, i64 0, i32 0, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_45_count);
  llvm_cbe_tmp__13 = (signed int *)(&llvm_cbe_tmp__12->field0);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = load i32* %%17, align 4, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_46_count);
  llvm_cbe_tmp__14 = (unsigned int )*llvm_cbe_tmp__13;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = mul nsw i32 %%18, %%storemerge3.us, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_47_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = add nsw i32 %%19, %%storemerge12.us, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_48_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = sext i32 %%20 to i64, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_49_count);
  llvm_cbe_tmp__17 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = getelementptr inbounds %%struct.F2D* %%16, i64 0, i32 2, i64 %%21, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_50_count);
  llvm_cbe_tmp__18 = (float *)(&llvm_cbe_tmp__12->field2[(((signed long long )llvm_cbe_tmp__17))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%llX",((signed long long )llvm_cbe_tmp__17));
}
if (AESL_DEBUG_TRACE)
printf("\n  store float %%15, float* %%22, align 4, !dbg !4 for 0x%llxth hint within @fDeepCopy  --> \n", ++aesl_llvm_cbe_51_count);
