...
if (AESL_DEBUG_TRACE)
printf("\n  call void @fMallocHandle(i32 1, i32 3, %%struct.F2D** %%kernel_1) nounwind, !dbg !6 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_24_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float 1.000000e+00, float* %%6, align 4, !dbg !6 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_34_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float 2.000000e+00, float* %%8, align 4, !dbg !6 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_43_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float 1.000000e+00, float* %%10, align 4, !dbg !6 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_52_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float 1.000000e+00, float* %%12, align 4, !dbg !7 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_64_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float 0.000000e+00, float* %%14, align 4, !dbg !7 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_73_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float -1.000000e+00, float* %%16, align 4, !dbg !7 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_82_count);
  *llvm_cbe_tmp__16 = -0x1p0;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", -0x1p0);
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = add nsw i32 %%4, -1, !dbg !6 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_88_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = load i32* %%3, align 4, !dbg !4 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_138_count);
  llvm_cbe_tmp__20 = (unsigned int )*llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = mul nsw i32 %%23, %%storemerge19.us, !dbg !4 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_139_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = load %%struct.F2D** %%kernel_2, align 8, !dbg !4 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_144_count);
  llvm_cbe_tmp__22 = (l_struct_OC_F2D *)*(&llvm_cbe_kernel_2);
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = add nsw i32 %%storemerge417.us, -1, !dbg !4 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_145_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = add nsw i32 %%26, %%24, !dbg !4 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_146_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = add nsw i32 %%43, %%24, !dbg !4 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_191_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%52, float* %%59, align 4, !dbg !8 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_225_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%71 = load float* %%70, align 4, !dbg !9 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_291_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%73 = load float* %%72, align 4, !dbg !9 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_293_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%80 = load float* %%79, align 4, !dbg !9 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_314_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%82 = load float* %%81, align 4, !dbg !9 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_316_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%90 = load float* %%89, align 4, !dbg !9 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_338_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%92 = load float* %%91, align 4, !dbg !9 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_340_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%95, float* %%102, align 4, !dbg !7 for 0x%llxth hint within @calcSobel_dX  --> \n", ++aesl_llvm_cbe_369_count);
