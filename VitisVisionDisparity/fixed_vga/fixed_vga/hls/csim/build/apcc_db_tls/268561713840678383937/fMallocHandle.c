...
printf("\ncols = 0x%X\n", llvm_cbe_cols);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sext i32 %%rows to i64, !dbg !5 for 0x%llxth hint within @fMallocHandle  --> \n", ++aesl_llvm_cbe_40_count);
  llvm_cbe_tmp__7 = (unsigned long long )((signed long long )(signed int )llvm_cbe_rows);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = shl nsw i64 %%3, 2, !dbg !5 for 0x%llxth hint within @fMallocHandle  --> \n", ++aesl_llvm_cbe_41_count);
  llvm_cbe_tmp__8 = (unsigned long long )llvm_cbe_tmp__7 << 2ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = sext i32 %%cols to i64, !dbg !5 for 0x%llxth hint within @fMallocHandle  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__9 = (unsigned long long )((signed long long )(signed int )llvm_cbe_cols);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = mul i64 %%4, %%5, !dbg !5 for 0x%llxth hint within @fMallocHandle  --> \n", ++aesl_llvm_cbe_44_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add i64 %%6, 8, !dbg !5 for 0x%llxth hint within @fMallocHandle  --> \n", ++aesl_llvm_cbe_45_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = call noalias i8* @malloc(i64 %%7) nounwind, !dbg !5 for 0x%llxth hint within @fMallocHandle  --> \n", ++aesl_llvm_cbe_46_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = bitcast i8* %%8 to %%struct.F2D*, !dbg !5 for 0x%llxth hint within @fMallocHandle  --> \n", ++aesl_llvm_cbe_47_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = add i64 %%4, 8, !dbg !5 for 0x%llxth hint within @fMallocHandle_rep1  --> \n", ++aesl_llvm_cbe_64_count);
  llvm_cbe_tmp__18 = (unsigned long long )((unsigned long long )(llvm_cbe_tmp__17&18446744073709551615ull)) + ((unsigned long long )(8ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
...
printf("\ncols = 0x%X\n", llvm_cbe_cols);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sext i32 %%rows to i64, !dbg !5 for 0x%llxth hint within @fMallocHandle_rep0  --> \n", ++aesl_llvm_cbe_116_count);
  llvm_cbe_tmp__29 = (unsigned long long )((signed long long )(signed int )llvm_cbe_rows);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = shl nsw i64 %%3, 2, !dbg !5 for 0x%llxth hint within @fMallocHandle_rep0  --> \n", ++aesl_llvm_cbe_117_count);
  llvm_cbe_tmp__30 = (unsigned long long )llvm_cbe_tmp__29 << 2ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__30);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = sext i32 %%cols to i64, !dbg !5 for 0x%llxth hint within @fMallocHandle_rep0  --> \n", ++aesl_llvm_cbe_119_count);
  llvm_cbe_tmp__31 = (unsigned long long )((signed long long )(signed int )llvm_cbe_cols);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = mul i64 %%4, %%5, !dbg !5 for 0x%llxth hint within @fMallocHandle_rep0  --> \n", ++aesl_llvm_cbe_120_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add i64 %%6, 8, !dbg !5 for 0x%llxth hint within @fMallocHandle_rep0  --> \n", ++aesl_llvm_cbe_121_count);
  llvm_cbe_tmp__33 = (unsigned long long )((unsigned long long )(llvm_cbe_tmp__32&18446744073709551615ull)) + ((unsigned long long )(8ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", ((unsigned long long )(llvm_cbe_tmp__33&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = call noalias i8* @malloc(i64 %%7) nounwind, !dbg !5 for 0x%llxth hint within @fMallocHandle_rep0  --> \n", ++aesl_llvm_cbe_122_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = bitcast i8* %%8 to %%struct.F2D*, !dbg !5 for 0x%llxth hint within @fMallocHandle_rep0  --> \n", ++aesl_llvm_cbe_123_count);
