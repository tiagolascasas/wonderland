...
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds %%struct.I2D* %%16, i64 0, i32 1, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_48_count);
  llvm_cbe_tmp__12 = (signed int *)(&llvm_cbe_tmp__10->field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = load i32* %%18, align 4, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
  llvm_cbe_tmp__13 = (unsigned int )*llvm_cbe_tmp__12;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = getelementptr inbounds %%struct.I2D* %%16, i64 0, i32 0, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_52_count);
  llvm_cbe_tmp__14 = (signed int *)(&llvm_cbe_tmp__10->field0);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = load i32* %%20, align 4, !dbg !13 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_53_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = call i32* @photonReportTiming(i32* %%22, i32* %%44) nounwind, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_91_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = bitcast i32* %%22 to i8*, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_106_count);
  llvm_cbe_tmp__42 = ( char *)(( char *)llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  call void @free(i8* %%48) nounwind, !dbg !14 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_107_count);
  free(( char *)llvm_cbe_tmp__42);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = bitcast i32* %%44 to i8*, !dbg !16 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_108_count);
  llvm_cbe_tmp__43 = ( char *)(( char *)llvm_cbe_tmp__38);
if (AESL_DEBUG_TRACE)
printf("\n  call void @free(i8* %%49) nounwind, !dbg !16 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_109_count);
