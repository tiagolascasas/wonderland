...
signed int *photonEndTiming(void);
...
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @photonEndTiming\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call noalias i8* @malloc(i64 8) nounwind, !dbg !2 for 0x%llxth hint within @photonEndTiming  --> \n", ++aesl_llvm_cbe_1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = bitcast i8* %%1 to i32*, !dbg !2 for 0x%llxth hint within @photonEndTiming  --> \n", ++aesl_llvm_cbe_2_count);
  llvm_cbe_tmp__2 = (signed int *)((signed int *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  tail call fastcc void @aesl_internal_magic_timing_begin(i32* %%2), !dbg !3 for 0x%llxth hint within @photonEndTiming  --> \n", ++aesl_llvm_cbe_6_count);
